...
class DashboardController extends Controller
{
    ...
    {
        $sessions = AcademicSession::latest()->get();
        return view('distributor.academic-sessions', compact('sessions'));
    }
    ...
    public function retailer_save_catalogue(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'catalogue_title' => 'required|string|max:255',
    ...
    public function retailer_delete_catalogue(Request $request)
    {
        try {
            $catalogue = Catalogue::where('id', $request->id)->where('user_id', auth()->id())->firstOrFail();
            $catalogue->delete();
    ...
    public function retailer_update_catalogue(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'catalogue_id' => 'required|exists:catalogues,id',
    ...
    public function retailer_manage_records()
    {
        $purchase_records = PurchaseRecord::where('user_id', auth()->id())->latest()->get();
        return view('retailer.manage-records', compact('purchase_records'));
    }

    public function retailer_save_purchase_record(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'record_name' => 'required|string|max:255',
    ...
    public function retailer_update_purchase_record(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'id' => 'required|exists:purchase_records,id',
    ...
    public function retailer_delete_purchase_record(Request $request)
    {
        try {
            $record = PurchaseRecord::where('id', $request->id)->where('user_id', auth()->id())->firstOrFail();
            $record->delete();
    ...
    public function retailer_download_invoice($id)
    {
        try {
            $record = PurchaseRecord::where('id', $id)->where('user_id', auth()->id())->firstOrFail();
    ...
    public function retailer_boards()
    {
        $boards = Board::latest()->get();
        return view('retailer.boards', compact('boards'));

    }
    public function retailer_save_board(Request $request)
    {
    ...
    public function retailer_update_board(Request $request)
    {
        try {
            $data = $request->validate([
                'id' => 'required|exists:boards,id',
    ...
    public function retailer_delete_board(Request $request)
    {
        Board::where('id', $request->id)->delete();
    ...
    public function retailer_academic_sessions()
    {
        $sessions = AcademicSession::latest()->get();
        return view('retailer.academic-sessions', compact('sessions'));
    }

    public function retailer_save_academic_session(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'name' => 'required|string|max:255|unique:academic_sessions,name',
    ...
    public function retailer_update_academic_session(Request $request)
    {
        try {
            $data = $request->validate([
                'id' => 'required|exists:academic_sessions,id',
    ...
    public function retailer_delete_academic_session(Request $request)
    {
        AcademicSession::where('id', $request->id)->delete();
    ...
    public function retailer_save_medium(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'board_id' => 'required|integer|exists:boards,id',
    ...
    public function retailer_update_medium(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'id' => 'required|integer|exists:mediums,medium_id',
    ...
    public function retailer_delete_medium(Request $request)
    {
        Medium::where('medium_id', $request->id)->delete();

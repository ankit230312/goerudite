                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn-sm btn-solid danger"
                                    onclick="openDeleteModal({{ $session->id }}, '{{ $session->name }}')">Delete</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('addSessionForm').addEventListener('submit', function(e) {
                ...
                console.log("ROUTE:", "{{ route('publisher.save-academic-session') }}");
                fetch("{{ route('publisher.save-academic-session') }}", {
                        method: "POST",
                        headers: {
            ...
            document.getElementById('editSessionForm').addEventListener('submit', function(e) {
                ...
                fetch("{{ route('publisher.academic-session.update') }}", {
                        method: "POST",
                        headers: {
        ...
        <script>
            ...
            function deleteSession() {
                fetch("{{ route('publisher.academic-session.delete') }}", {
                        method: "POST",
                        headers: {

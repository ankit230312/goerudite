    ...
    <div class="shop-container">
        ...
        <aside class="sidebar-filters">
            ...
            <div class="filter-section">
                ...
                <div class="filter-options-grid">
                    <div class="filter-option">
                        ...
                        <label for="upsc">UPSC / State PSC</label>
                    </div>
                    <div class="filter-option">
            ...
            <div class="filter-section">
                ...
                <div class="filter-options-grid">
                    ...
                    <div class="filter-option">
                        ...
                        <label for="primary">Primary (1-5)</label>
                    </div>
                    <div class="filter-option">
                        <input type="checkbox" id="middle">
                        <label for="middle">Middle (6-8)</label>
                    </div>
                    <div class="filter-option">
            ...
            <div class="filter-section">
                ...
                <div class="filter-options-grid">
                    <div class="filter-option">
                        <input type="checkbox" id="session2026">
                        <label for="session2026">2026-27 New</label>
                    </div>
                    <div class="filter-option">
                        <input type="checkbox" id="session2025">
                        <label for="session2025">2025-26 New</label>
                    </div>
                    <div class="filter-option">
                        <input type="checkbox" id="session2025">
                    ...
                    <div class="filter-option">
                        ...
                        <label for="session2023">2022-23</label>
                    </div>
                    <div class="filter-option">
                        <input type="checkbox" id="session2024">
                        <label for="session2024">2024-25 Old</label>
                    </div>
                </div>
            ...
            <div class="important-tip">
                ...
                List your services on GoErudite and reach 10,000+ schools. Find price subject to seller terms. Platform does
                not influence publisher MRP.
            </div>

            <!-- Black Note Box -->
            <div class="important-tip bg-dark">
                <strong>Important Tips:</strong>
                Schools are advised to use the "Direct Inquiry workflow to generate a digitally signed Request for Quotation
                (RFQ) which ensures legal traceability under the Indian Education Supply Compliance Act.
            </div>
                ...
                @foreach ($catalogues as $catalog)
                    <div class="product-card">
                        ...
                        <div class="product-image">
                            @if ($catalog->cover_file)
                                <img src="{{ asset('storage/' . $catalog->cover_file) }}"
                                    alt="{{ $catalog->catalogue_title }}">
                            @else
                        ...
                        <div class="product-info">
                            <a href="{{ route('catalog.detail', $catalog->id) }}" class="text-decoration-none">
                                <h3>{{ $catalog->catalogue_title }}</h3>
                            </a>

                            <div class="product-meta">
                                <span class="meta-badge cbse">
                                    {{ $catalog->applicable_board }}
                                </span>

                                <span class="meta-badge">
                                    {{ $catalog->mediumDetail->name ?? $catalog->medium }}
                                </span>
                        ...
                        <div class="product-pricing">
                            <div class="prices">
                                <span class="mrp">
                                    MRP ₹{{ number_format($catalog->mrp, 0) }}
                                </span>

                                {{-- If you have selling price field --}}
                                <span class="selling-price">
                                    ₹{{ number_format($catalog->mrp, 0) }}
                                </span>
                            </div>
